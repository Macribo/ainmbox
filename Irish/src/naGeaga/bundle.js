...
//12
`
<span id='Fine.'>Go brea.</span><span id='what is'> Cad é </span><span id='your choice of team?'>do rogha foireann?</span>
...
//Event Handlers
    ...
    window.location.replace("http://ribodev.com/3ire3ile/src/naContae/naContae.html");
    }
...
function joinTeamHandler(){
    ...
    joinTeam.style.display='none';
    setTimeout(function(){
    window.location.replace("http://ribodev.com/3ire3ile/src/naGeaga/naContae/contaePages/naContae"+countyId +".html");
...
},{"./county-names":3,"./story-texts":9,"./title-texts":10}],6:[function(require,module,exports){
/*jshint esnext: true */

//
//
var badgeSelectorL = require("./badge-selector-l");
var badgeSelectorR = require("./badge-selector-r");
...
var selectLevel = document.querySelector('#selectLevel');
var output2 = document.querySelector('#output2');
var suile= document.querySelector('#súile');
...
console.log("GS "+geagaSceal);
    ...
    if (geagaSceal === 2){
        ...
        portrait.style.opacity="1";
            tidyBox1.style.display="inline";
    }
    if (geagaSceal === 3){
            tidyBox1.style.display="none";
    ...
    if(geagaSceal === 6&& (coSelect)){
               suile.style.backgroundImage='url("../../images/suile.gif")'; 
        naContaeResources.style.display="inline";
        fwdBtn.style.display="none";
        console.log("selectCounty anseo");
        countyBtnLeft.style.display="inline";
        countyBtnRight.style.display="inline";
        imreoirWLv.style.display="none";
        output2.innerHTML="";
        output.innerHTML="Roghnaigh Foireann";
...
function levelSelectHandler(){
    ...
    console.log("We need another system.");
    coSelect =true;
    levelSelect.style.display="none";
   ...
   badgeSelectorL(100);
    badgeSelectorR(100);
     ...
     console.log("***Anseo!");       tidyBox1.style.display="none";
...
function leaveHandler(){
    console.log("koo");
   window.location.replace("http://ribodev.com/3ire3ile/src/naGeaga/naContae/contaePages/naContae10.html"); 
}
...
},{"./badge-selector-l":1,"./badge-selector-r":2,"./geaga-teacs":4}],7:[function(require,module,exports){
 //jshint esversion:6 
...
if(clickCounter===1){ $('#bearla').text('What Irish do you have?');
             $(this).css('color','#e35ee5');
            }
...
//2
  `<span id='(I know) a few words'>Cúpla focal</span>
  `,
//3
 ...
 //4   
   `<span id='I am fluent'>Tá mé líofa</span>
  `,
