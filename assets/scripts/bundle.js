...
})(
  {
    ...
    2: [
      function(require, module, exports) {
        ...
        var fwdbck = document.querySelector('#fwdbck');
...
`,
          ...
          `<span id='A Question...'>Ceist...</span> <br>
          <span id='It is accepted'>Glachtar leis</span><span id='that communication'> gur cumarsáid</span>
<span id='is the purpose of language'> aidhm teanga.
</span><br/>
<br/>
<div style="animation: delay-fade-in 2s;">
<span id='But'> Ach </span>
<span id='is language involved'>an glachann teanga pairt </span><span id='in the shaping of ideas'>i cruthú turaimíocht </span><span id='also?'>freisin?</span>
</div>`,

          ////9 <div style="animation:delay-fade-in 2s;">
          /*  aidhm teanga. 'Sé sin le rá tá teangaí i gcomhair  turaimí a roinnt agus a phlé.  
 `<span id='Secondly'> Sa dara h-áit</span>, Ach an glachann teanga pairt i cruthú na turaimí sin, freisin?
...
Buntús an tríal seo ná Spás digitach a 

`,
*/
          //10
          `
<span id='Hypothesis'>Hipitéis</span> <span id='of this App'>an App seo</span>: <ul>
<br>
<br>
